...
void deselect (void)
{
    GPIO_PortSet(BOARD_SD_GPIO, 1U << BOARD_SD_CS_GPIO_PIN);   //CHIP_SELECT=1; 
...
{
	GPIO_PortClear(BOARD_SD_GPIO, 1U << BOARD_SD_CS_GPIO_PIN); // CHIP_SELECT=0; //SD_CS_SetLow();	/* Set CS# low */
