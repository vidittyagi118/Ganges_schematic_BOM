...
#define DEFAULT_PWM1_CH1_DUTY_CYCLE             0
#define DEFAULT_PWM1_CH2_DUTY_CYCLE             0
...
{  
  ...
  */
  ...
  FTM_SetupPwm(PWM1_FTM_BASEADDR, ftmParam, 2U, kFTM_EdgeAlignedPwm, 24000U, FTM_SOURCE_CLOCK);
